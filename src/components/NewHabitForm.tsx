...
export function NewHabitForm() {
  ...
  return (
    <form onSubmit={createNewHabit} className='w-full flex flex-col mt-6'>
      ...
      className='p-4 rounded-lg mt-3 bg-zinc-800 text-white focus:outline-none placeholder:text-zinc-400 focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-zinc-900'
      autoFocus
      value={title}
